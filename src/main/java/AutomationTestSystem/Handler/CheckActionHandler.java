...
import AutomationTestSystem.Service.WebXmlParseService;
...
public class CheckActionHandler {
	...
	public void weblistSizeNotZero(TestStep step) throws Exception {
		List<Map<String, Object>> list = (List<Map<String, Object>>) SeleniumUtil
				.parseEL(step.getDetails().get("subject"));
	...
	public void androidlistSizeNotZero(TestStep step) throws Exception {
		List<Map<String, Object>> list = (List<Map<String, Object>>) AppiumUtil
				.parseEL(step.getDetails().get("subject"));
